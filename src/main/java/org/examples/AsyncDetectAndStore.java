...
public class AsyncDetectAndStore {
    ...
    public static void main(String[] args) {
        ...
        String status = getJobResults(textractClient, s3Client, jobId);
    ...
    private static String getJobResults(TextractClient textractClient, S3Client s3Client, String jobId) {
